function []=move2(p,x,y,z,th)
 global orig
 rot = angle2dcm1(th,0,0); %Create a rotation matrix from euler angles --- NOT the way you'll be doing it, but easy for this example.
 % replace this direct cosine matrix formulation
